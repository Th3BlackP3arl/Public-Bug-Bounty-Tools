...
echo "\e[1;32m[!] Searching Censys... \e[0m";
python /root/imxx/subdomain_takeover_tools/1-censys-subdomain-finder/censys_subdomain_finder.py $1 > censys


#Summing Up
echo "";
cat crt wayback hackertarget certspotter threatcrowd virustotal censys | sort -u > subdomains.txt
rm crt wayback hackertarget certspotter threatcrowd virustotal censys
